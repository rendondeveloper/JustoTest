package com.rendonsoft.justotest.utils.retrofit.builder

import android.content.Context
import com.jakewharton.retrofit2.adapter.kotlin.coroutines.CoroutineCallAdapterFactory
import com.rendonsoft.justotest.utils.retrofit.interceptor.ConnectionInterceptor
...
class RetrofitApp<T> private constructor(
    ...
    private fun retrofitClient(): Retrofit.Builder {
        ...
        //TODO Implementation interceptor headers for example
        //httpClient.addInterceptor(it)

        //TODO Implementation tokens for example
